...
IF(CMAKE_SYSTEM_PROCESSOR STREQUAL "x86" OR CMAKE_SYSTEM_PROCESSOR STREQUAL "i686" OR CMAKE_SYSTEM_NAME MATCHES "Windows" OR FORCE32 OR CMAKE_SYSTEM_PROCESS MATCHES "armv7")
...
ELSE ()
    ...
    ELSEIF (CMAKE_SYSTEM_NAME MATCHES "Darwin")
        set(ARCH_DIR "Darwin_x86_64-gcc")
    ENDIF(CMAKE_SYSTEM_NAME MATCHES "BSD")
ENDIF(CMAKE_SYSTEM_PROCESSOR STREQUAL "x86" OR CMAKE_SYSTEM_PROCESSOR STREQUAL "i686" OR CMAKE_SYSTEM_NAME MATCHES "Windows" OR FORCE32)
